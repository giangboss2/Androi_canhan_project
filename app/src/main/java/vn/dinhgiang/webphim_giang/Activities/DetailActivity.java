...
import vn.dinhgiang.webphim_giang.Adapters.ActorsListAdapter;
import vn.dinhgiang.webphim_giang.Adapters.CategoryEachFilmListAdapter;
import vn.dinhgiang.webphim_giang.Adapters.CategoryListAdapter;
import vn.dinhgiang.webphim_giang.Domain.FilmItem;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private int idFilm;
    private ImageView pic2, backImp;
    ...
    private void initView() {
        ...
        movieRateTxt=findViewById(R.id.movieStart);
        movieTimeTxt=findViewById(R.id.movieTime);
        movieSummaryInfo=findViewById(R.id.movieSummery);
        movieActorsInfo=findViewById(R.id.movieActorInfo);
        backImp=findViewById(R.id.backImp);
        recyclerViewCategory=findViewById(R.id.geneView);
        recyclerViewActors=findViewById(R.id.imagesRecycler);
        recyclerViewActors.setLayoutManager(new LinearLayoutManager(this,LinearLayoutManager.HORIZONTAL,false));
        recyclerViewCategory.setLayoutManager(new LinearLayoutManager(this,LinearLayoutManager.HORIZONTAL,false));

        backImp.setOnClickListener(new View.OnClickListener() {
            @Override
